...
// Рівень сигналу в відсотках: -50 dBm і вище - 100%, -100 dBm і нижче - 0%,
// між ними лінійно.
//
// Тут - з тієї ж причини, що й wifiAuthTypeName() вище: тим самим числом
// підписаний рядок у 'status sys', напис на екрані пристрою і таблиця
// профілів у веб-порталі, тобто і src/, і lib/. Друга копія формули
// розійшлась би з першою мовчки - в обох випадках це просто "%", і
// розбіжність видно лише якщо дивитись на два екрани одночасно.
//
// Шкала умовна (dBm -> "якість" однозначно не переводиться), але вона має
// бути ОДНА: користувач порівнює показання між екраном і сторінкою.
