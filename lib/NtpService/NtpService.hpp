...
public:
  ...
  void begin(long gmtOffsetSec, int daylightOffsetSec, const char* ntpServer1,
             const char* ntpServer2 = nullptr, const char* ntpServer3 = nullptr,
  ...
  void beginTz(const char* tzString, const char* ntpServer1, const char* ntpServer2 = nullptr,
               const char* ntpServer3 = nullptr, uint32_t syncIntervalMs = 60000);
  ...
  static const char* ftime(
      const char* format, char* buffer, size_t max,
...
private:
  ...
  static const char* _formatTime(const char* format, char* buffer, size_t max, time_t sec,
                                 long usec, bool applyTimeZone);
