...
//   LittleFS "/www"  ->  вшитий у прошивку fallback (ProgmemStaticSource)
// Порожній або щойно стертий 'pio run -t uploadfs' розділ не робить пристрій
// ненастроюваним: вбудована сторінка вміє те саме, просто виглядає скромніше.
//
