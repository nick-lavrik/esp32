...
public:
    ...
    // POD/struct (bin, не JSON). T має бути trivially copyable (без String/pointers/vector всередині).
    //
    ...
    //  2. Обов'язково `__attribute__((packed))` - інакше compiler padding може відрізнятись між файлами.
