// ЗГЕНЕРОВАНО НЕ НАМИ - це шрифт з Adafruit-GFX-Library (Fonts/FreeSansBold12pt7b.h),
// покладений у проєкт як є. Оригінал тягне <Adafruit_GFX.h> заради типу
// GFXfont; тут цей include ПРИБРАНО - Arduino_GFX оголошує ту саму структуру
// у власному gfxfont.h, а підключення Adafruit_GFX дало б подвійне
// визначення GFXfont/GFXglyph і збірка б упала.
//
// Шрифти сімейства Free* - це GNU FreeFont (GPL з font exception).
#pragma once
