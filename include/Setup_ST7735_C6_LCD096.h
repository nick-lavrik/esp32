...
//
// Офсети CASET/RASET (col_offset=1, row_offset=26) з тестового коду
// (Offset_X/Offset_Y) — 160+2*1=162 і 80+2*26=132 точно відповідають
// нативному GRAM ST7735 (132x162) — додаткове підтвердження, що чіп
// справді ST7735, а не ST7789 (у якого GRAM 240x320).
//
...
// setupDisplay(). Піни (зі схеми плати, підтверджені тестовим кодом):
...
//
// Офсети (1, 26, 1, 26): нативний GRAM ST7735 - 132x162; видима область
// 160x80 центрована в ньому симетрично по обох осях (162-160=2 -> 1+1,
// 132-80=52 -> 26+26) - тому offset1 == offset2 по кожній осі.
