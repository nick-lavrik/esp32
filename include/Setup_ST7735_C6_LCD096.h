...
//
// НАСЛІДОК-ПАСТКА №2: звертатися до картки з-під ВІДКРИТОЇ транзакції
// дисплея не можна — SPIClass::beginTransaction() бере не рекурсивний
// мьютекс із portMAX_DELAY, і плата зависає намертво. А loop() тримає цю
...
// SD_SHARES_DISPLAY_SPI=1 — будь-який НОВИЙ код, що читає SD з команди,
