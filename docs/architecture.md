...
див. розділ «Request-response для команд» вище).
...
- **Телеметрія EcoFlow** (обидві C6-плати): заряд, наявність мережі, час до заряду/розряду
...
- 2026-08-31 — **request-response для команд по MQTT**: вивід команди, надісланої в
  ...
  «Request-response для команд» вище; тести — блок **M12–M17** у `docs/test_plan.md`.
